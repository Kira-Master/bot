...
ownerNumber = [`${setting.noown}@s.whatsapp.net`,`6282322153431@s.whatsapp.net`,`6282322153431@s.whatsapp.net`]
fake = '𝙆𝙞𝙧𝙖 𝙈𝙖𝙨𝙩𝙚𝙧'// ini fake
namaown = '𝙆𝙞𝙧𝙖 𝙈𝙖𝙨𝙩𝙚𝙧'//ama owner
noown = 6282322153431 //nomor owner
namabot = '𝙆𝙔𝙐𝙍𝘼 𝘽𝙊𝙏' // nama bot
namabot2 = '𝙆𝙔𝙐𝙍𝘼 𝘽𝙊𝙏' // nama bot ⟨ nama bot ⟩
ytown = 'https://youtube.com/channel/NothingToLose' //setting.ytown
githubown = setting.githubown
igown = 'https://instagram.com/kii1raaa_' //setting.igown
imgmenu = '𝙆𝙔𝙐𝙍𝘼 𝘽𝙊𝙏' //setting.imgmenu
...
"mediaUrl": "https://Instagram.com/kii1raaa_",
"thumbnail": fakeimage,
"sourceUrl": "https://github.com/Kira-Master"
},mentionedJid:[sender]}, quoted : mek})
}

   //FAKEREPLY PRODUCT
            const ftoko = {
            key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./image/thumb.jpeg`)},"title": `NGEJUDI GAK BROH?\n${pushname}`,"description": "𝙆𝙞𝙧𝙖 𝙈𝙖𝙨𝙩𝙚𝙧", "currencyCode": "IDR","priceAmount1000": "9999999999","retailerId": "𝙆𝙔𝙐𝙍𝘼 𝘽𝙊𝙏","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
            //FAKE KONTAK
            const fkontak = { 
...
const fvid = {
	 ...
	 message: { 
      ...
      if (!packname) packname = 'LILJEE\n<3';
      if (!author) author = '𝙆𝙔𝙐𝙍𝘼 𝘽𝙊𝙏';
...
┏◪ *_INFO DEVELOPER_*
┃🌹 ${G}Nama${G} : ${G}𝙆𝙞𝙧𝙖 𝙈𝙖𝙨𝙩𝙚𝙧${G}
┃🌹 ${G}NO${G} : ${G}wa.me/6282322153431${G}
┃🌹 ${G}script${G} : ${G}ketik !sc${G}
┃🌹 ${G}YouTube${G} :  ${G}Fauzi Matsukio${G}
┗◪
`
// seperti biasa kawan²
// saya enc
...
footerText: 'Follow IG : kii1raaa_\nMade With ❤️ By 𝙆𝙞𝙧𝙖 𝙈𝙖𝙨𝙩𝙚𝙧',
    
buttons: gbutsanmm,
    
headerType: 4
}
await ALDI.sendMessage(from, gbuttonanq, MessageType.buttonsMessage,{ quoted:ftroli, sendEphemeral: true, contextInfo: { forwardingScore: 508, isForwarded: true, "externalAdReply": { "title": `hallo ${pushname}`, "body": "Follow IG @kii1raaa_", "previewType": "PHOTO", "thumbnailUrl": `${imgmenu}`, "thumbnail": fs.readFileSync('./image/thumb.jpeg'), "sourceUrl": "https://wa.me/6283197878426"}}})
...
break
            ...
            se =`
scrip:
https://youtube.com/channel/nothingtolose
...
if ((args[0]) == 'ngetik'){
			...
			headerType: "IMAGE",
			contentText: "Active!!",
			footerText: '𝙆𝙞𝙧𝙖 𝙈𝙖𝙨𝙩𝙚𝙧',
			buttons: buttons,
			headerType: 1
			}
            ALDI.sendMessage(from, buttonMessage, MessageType.buttonsMessage, 
            {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6285697725326@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": `*𝐒𝐄𝐋𝐅 𝙆𝙞𝙧𝙖 𝙈𝙖𝙨𝙩𝙚𝙧*\n${gaya}Made By: 𝙆𝙞𝙧𝙖 𝙈𝙖𝙨𝙩𝙚𝙧${gaya}`, 'jpegThumbnail': fs.readFileSync('./image/thumb.jpeg')}}}})
   		    break	            
//====[ CASE BC ]===\\
case 'buttonbc':
