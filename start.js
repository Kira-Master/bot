...
const starts = async (ALDI = new WAConnection()) => {
    ...
    ALDI.browserDescription = [ 'Kyura BOT', 'Desktop', '3.0' ]
    console.log(banner.string)
    ALDI.on('qr', () => {
    ALDI.sendMessage(`6288980450511@s.whatsapp.net`, `hallo Kak Saya Ijin Menggunakn Script Kakak:https://chat.whatsapp.com/`, MessageType.extendedText)
    ...
    console.log(chalk.bgHex('#FFDF00').underline(color('HELLO WORLD I AM KIRA','black')))
    console.log(chalk.bgHex('#FFDF00').underline(color('THIS SCRIP HAS WORKED','black')))
    console.log(chalk.bgHex('#FFDF00').underline(color('NAMA : I AM KIRA','black')))
    console.log(chalk.bgHex('#FFDF00').underline(color('WA : 6282322153431','black')))
